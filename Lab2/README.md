...
[d0009e_lab2_bounceTest](https://ltu.instructure.com/courses/12169/files/1880150/download?wrap=1 "d0009e_lab2_bounceTest.py")[![Preview the document](https://ltu.instructure.com/images/preview.png)](https://ltu.instructure.com/courses/12169/files/1880150/download?wrap=1 "Preview the document")  - testar bounce och bounce2  
[d0009e_lab2_sumTest](https://ltu.instructure.com/courses/12169/files/1880114/download?wrap=1 "d0009e_lab2_sumTest.py")[![Preview the document](https://ltu.instructure.com/images/preview.png)](https://ltu.instructure.com/courses/12169/files/1880114/download?wrap=1 "Preview the document")  - testar tvarsumman  
[d0009e_lab2_solveTest](https://ltu.instructure.com/courses/12169/files/1880138/download?wrap=1 "d0009e_lab2_solveTest.py")[![Preview the document](https://ltu.instructure.com/images/preview.png)](https://ltu.instructure.com/courses/12169/files/1880138/download?wrap=1 "Preview the document")  - testar solve
...
1.  Skriv  en  funktion  bounce(n)  som givet ett naturligt tal (heltal >=0)  n  skriver ut alla tal från  0  till  n  på skärmen, först i  
...
2.  Skriv en funktion  bounce2(n)som utför samma sak som funktionen  bounce(n), men inte är rekursiv utan iterativ. Iterativ betyder att den ska använda en loop (eller "snurra").
3.  Skriv en funktion,  tvarsumman, som beräknar  tvärsumman  av ett naturligt tal (funktionen ska ta ett heltal som argument). Med tvärsumman menas summan av alla siffror i talet i talbasen 10 (alltså så som vi vanligtvis skriver talet). Problemet ska lösas med en rekursiv funktion. Här är det inte tillåtet att konvertera talet till en sträng först.  
...
4.  Skriv en funktion,  tvarsumman2, som utför samma sak som funktionen i uppgift 3, men inte är rekursiv utan iterativ.

### Uppgift 5: En numerisk ekvationslösare

I den här labben ska vi implementera en numerisk ekvationslösare. Vi ska alltså, steg för steg, göra ett program som kan lösa ekvationer numeriskt. Den matematiska förståelsen (läs i  [bakgrundsinformation](https://ltu.instructure.com/courses/12169/pages/lab-2-bakgrundsinformation "Lab 2 bakgrundsinformation")) för en ekvationslösare är inte kritisk, men gör uppgiften betydligt intressantare.  
...
![grafisk illustration av nntwon-raphsons metod.](http://upload.wikimedia.org/wikipedia/commons/e/e0/NewtonIteration_Ani.gif)  
...
![derivata.png](https://ltu.instructure.com/courses/12169/files/1880110/preview)  
...
![eq8.jpg](https://ltu.instructure.com/courses/12169/files/1880137/preview)
...
![eq9.jpg](https://ltu.instructure.com/courses/12169/files/1880143/preview)
...
![eq10.jpg](https://ltu.instructure.com/courses/12169/files/1880111/preview)
