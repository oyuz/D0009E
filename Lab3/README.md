...
1.  fråga efter en parameter till bounce och kör sedan bounce med denna parameter
2.  fråga efter en parameter till tvärsumman och kör sedan tvärsumman med denna parameter
3.  fråga efter ett startvärde till newton-raphson och lös sedan f(x)=x^2-1 genom att anropa newton-raphson från lab 2.
...
2.  En lista av tupler. En enda lista som består av par, där första delen av varje par är ordet vi vill slå upp, och den andra är beskrivningen. Observera här altlså att datastrukturen ska vara en lista, varje element i denna lista ska i sin tur vara ett par (en tupel med två element).
3.  Ett dictionary. Ett dictionary som innehåller ordet vi vill slå upp som "nyckel" och tillhörande beskrivning som "värde".

För varje lösning ska två operationer finnas: en för att sätta in och en för att slå upp ord i listan. Varje operation ska implementeras som en egen funktion för att ge programmet bra struktur. Återanvänd gärna kod mellan de tre lösningarna (t.ex. kan du ha samma funktion som skriver ut själva menyn).
